...
class FillPermissionsForSimchange extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForSimchange constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.simchange',
            'admin.simchange.index',
            'admin.simchange.create',
            'admin.simchange.show',
            'admin.simchange.edit',
            'admin.simchange.delete',
            'admin.simchange.bulk-delete',
        ]);
