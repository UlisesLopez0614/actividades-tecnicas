...
class FillPermissionsForUninstallation extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForUninstallation constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.uninstallation',
            'admin.uninstallation.index',
            'admin.uninstallation.create',
            'admin.uninstallation.show',
            'admin.uninstallation.edit',
            'admin.uninstallation.delete',
            'admin.uninstallation.bulk-delete',
        ]);
