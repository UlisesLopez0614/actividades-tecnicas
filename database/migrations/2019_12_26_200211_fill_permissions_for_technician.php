...
class FillPermissionsForTechnician extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForTechnician constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.technician',
            'admin.technician.index',
            'admin.technician.create',
            'admin.technician.show',
            'admin.technician.edit',
            'admin.technician.delete',
            'admin.technician.bulk-delete',
        ]);
