...
class FillPermissionsForInstallation extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForInstallation constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.installation',
            'admin.installation.index',
            'admin.installation.create',
            'admin.installation.show',
            'admin.installation.edit',
            'admin.installation.delete',
            'admin.installation.bulk-delete',
        ]);
