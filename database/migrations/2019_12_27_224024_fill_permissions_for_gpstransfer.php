...
class FillPermissionsForGpstransfer extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForGpstransfer constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.gpstransfer',
            'admin.gpstransfer.index',
            'admin.gpstransfer.create',
            'admin.gpstransfer.show',
            'admin.gpstransfer.edit',
            'admin.gpstransfer.delete',
            'admin.gpstransfer.bulk-delete',
        ]);
