...
class FillPermissionsForGpschange extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForGpschange constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.gpschange',
            'admin.gpschange.index',
            'admin.gpschange.create',
            'admin.gpschange.show',
            'admin.gpschange.edit',
            'admin.gpschange.delete',
            'admin.gpschange.bulk-delete',
        ]);
