...
class FillPermissionsForHomologation extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForHomologation constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.homologation',
            'admin.homologation.index',
            'admin.homologation.create',
            'admin.homologation.show',
            'admin.homologation.edit',
            'admin.homologation.delete',
            'admin.homologation.bulk-delete',
        ]);
